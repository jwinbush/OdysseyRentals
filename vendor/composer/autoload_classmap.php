...
return array(
    ...
    'CartIndex' => $baseDir . '/views/cart/cart_index.class.php',
    ...
    'LocationIndex' => $baseDir . '/views/location/location_index.class.php',
    'OrderIndex' => $baseDir . '/views/cart/order/order_index.class.php',
