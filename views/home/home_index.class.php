...
class HomeIndex extends IndexView
{
    ...
    public function display()
    {
        ...
        <div class="container-alt">
            <div class="hero-wrapper w-full h-screen text-center overflow-hidden"
                ...
                <h1
                    class="pt-80 mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl">
                ...
                <!-- RESERVATION FORM -->
                <div class="reservation-form max-w-7xl mx-auto mt-64">
                    <div class="backdrop-blur-md p-8 bg-white/20 rounded-lg  md:flex text-sm">
                        <div class="md:w-1/5">
            ...
            <div class="discover-why-wrapper">
                <h1>Discover why we are the future of transportation</h1>
                <div class="discover-cards">
                    <div class="card">
                        <h2>125+</h2>
                        <h4>YEARS OF EXPERTISE</h4>
                        <p>in truck manufacturing</p>
                    </div>
                    <div class="card">
                        <h2>5M+</h2>
                        <h4>REAL-WORLD MILES</h4>
                        <p>of EV experience</p>
                    </div>
                    <div class="card">
                        <h2>0</h2>
                        <h4>EMISSIONS BRAND</h4>
                        <p>from a global OEM</p>
                    </div>
                </div>
            </div>
            ...
            <div class="our-story-wrapper">
                <video autoplay muted loop                                                                                                                                                                                      2 playsinline>
                    <source src="<?= BASE_URL ?>/www/video/our-story.mp4" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                <div class="content">
                    <h1>Inspired by sustainability</h1>
                    <p>Inspired to create a new benchmark for Class 4-5 trucks, we are proud to introduce a purely electric truck that is safe, reliable and efficient.</p>
                    <button>Discover Our Story</button>
                </div>
            </div>

            <!-- CATEGORIES -->
            <div class="car-categories-wrapper bg-white py-10">
                <div class="car-categories mx-auto">
                    ...
                    <div class="cat-cards">
                        <div class="cat-card  p-4">
                            ...
                            <div class="content"><h3>Economy</h3>
                        ...
                        <div class="cat-card  p-4">
                            ...
                            <div class="content"><h3>Luxury</h3>
                        ...
                        <div class="cat-card  p-4">
                            ...
                            <div class="content"><h3>Compact</h3>
                        ...
                        <div class="cat-card  p-4">
                            ...
                            <div class="content"><h3>Pick-up</h3>
                            <p>Explore our wide range of sedans for a comfortable and luxurious
                                driving experience.</p>
                        ...
                        <div class="cat-card  p-4">
                            ...
                            <div class="content"><h3>Convertibles</h3>
                            <p>Experience the thrill of driving with our convertible cars, perfect
                                for a stylish and open-air ride.</p>
                ...
                <div class="flex flex-wrap items-center">
                        ...
                        <div class="flex items-center mb-4">
                            <div class="flex-shrink-0">
                                <img class="w-12 h-12 object-cover rounded-full"
                                    src="https://cdns.iconmonstr.com/wp-content/releases/preview/2016/96/iconmonstr-car-2.png"
                    ...
                    <div class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                        <div class="flex items-center mb-4">
                            <div class="flex-shrink-0">
                                <img class="w-12 h-12 object-cover rounded-full"
                                    src="https://cdns.iconmonstr.com/wp-content/releases/preview/2016/96/iconmonstr-car-20.png"
                    ...
                    <div class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                        <div class="flex items-center mb-4">
                            <div class="flex-shrink-0">
                                <img class="w-12 h-12 object-cover rounded-full"
                                    src="https://cdns.iconmonstr.com/wp-content/releases/preview/2016/240/iconmonstr-car-16.png"
