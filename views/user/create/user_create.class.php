    ...
    public function display()
    {
        ...
        <body class="overflow-hidden">
            ...
            <div class="h-screen md:flex">
                <div class="overflow-hidden md:flex w-3/4 bg-cover bg-center i justify-around items-center hidden"
                    style="background-image: url('https://cdn.outsideonline.com/wp-content/uploads/2017/02/21/on-road-off-road-cars-trucks-12_h.jpg?width=2400&ratio=16/9')">
                    <div class="p-8 backdrop-blur-md w-[35vw]">
                        <h1 class="text-white font-extrabold text-2xl">Unlock Your Next Adventure</h1>
                        <p class="text-white mt-1">Become a member to access premium vehicles and special offers</p>
                        <a href="<?= BASE_URL ?>/user/login">
                            <button type="submit" class="block w-28 sign-up-button mt-4">Sign in
                            </button>
                        </a>
                    </div>
                ...
                <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
                    <form class="bg-white" action='<?= BASE_URL ?>/user/add' method="post">
                        ...
                        <div class="flex items-center border-2 py-2 px-3 rounded-lg mb-4">
                            ...
                            <input class="pl-2 outline-none border-none" type="text" name="firstname"
                        ...
                        <div class="flex items-center border-2 py-2 px-3 rounded-lg mb-4">
                            ...
                            <input class="pl-2 outline-none border-none" type="text" name="email" placeholder="Email Address" />
                        </div>
                        ...
                        <button class="sign-up-button block w-full mt-4 py-2 rounded-lg text-white mb-2">Sign Up
                        </button>
                        ...
                        <fieldset class="pt-10">
                            ...
                            <div class="flex items-center mb-4">
                                <input id="checkbox-1" type="checkbox" value=""
                                    class="w-4 h-4 text-orange-600 bg-gray-100 border-gray-300 rounded focus:ring-2"
                                    required>
                                <label for="checkbox-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I
                                    agree to the <a href="#" class="text-orange-600 hover:underline "
                                        data-modal-target="defaultModal" data-modal-toggle="defaultModal" id="terms">terms
                                        and conditions</a>.</label>
                            </div>

                            <!-- Main modal -->
                            <div id="defaultModal" tabindex="-1" aria-hidden="true" class="hidden modal">
                                <div class="relative w-full h-full max-w-2xl md:h-auto">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div
                                            ...
                                            <button data-modal-hide="defaultModal" type="button" id="accept"
                                                class="text-white bg-orange-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center">I
                                                accept</button>
                                            <button data-modal-hide="defaultModal" type="button" id="decline"
                                                class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Decline</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center mb-4">
                                <input id="checkbox-2" type="checkbox" value=""
                                    class="w-4 h-4 text-orange-600 bg-gray-100 border-gray-300 rounded dark:ring-offset-gray-800  focus:ring-2 ">
                            ...
                            <div class="flex items-center mb-4">
                                <input id="checkbox-3" type="checkbox" value=""
                                    class="w-4 h-4 text-orange-600 bg-gray-100 border-gray-300 rounded  focus:ring-2 " required>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const openModalBtn = document.getElementById('terms');
