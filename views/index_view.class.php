...
class IndexView
{
    ...
    static public function displayHeader($page_title)
    {
        ...
        <head>
            ...
            <link href='<?= BASE_URL ?>/dist/tailwind.css' rel="stylesheet"> <!-- Link to your Tailwind CSS -->

            <!--Tailwind CSS CDN-->

            <!--jQuery Section-->
            <title>UI Slider Test</title>
            ...
            <script>
                window.addEventListener('scroll', function () {
                    ...
                    // Set the backdrop blur effect and background color based on scroll position
                    if (scrollTop > (viewportHeight * 0.2)) { // Check if scroll is past 20vh
                        navbar.style.backdropFilter = 'blur(10px)'; // Apply blur effect
                        navbar.style.backgroundColor = '#ffffff21'; // 30% black
                    } else {
                        navbar.style.backdropFilter = 'none'; // Remove blur effect
                        navbar.style.backgroundColor = 'transparent'; // Restore background color
            ...
            <style>
                @font-face {
                    font-family: "Azonix";
                    src: url("<?= BASE_URL ?>www/font/Azonix.otf") format("otf");
                    /* Older browsers might require this format */
                    font-weight: 500;
                    font-style: normal;
                }
                ...
                <nav id="navbar" class="scrolled fixed w-full px-2 sm:px-4 py-2.5 z-50">
                    <div \ class="container flex flex-wrap items-center justify-between mx-auto">
                        <a href="<?= BASE_URL ?>" class="flex items-center">
                            <img src="<?= BASE_URL ?>/www/img/or-logo.png" class="w-12 mr-2 " alt="Logo" />
                            <span
                                class="logo-text self-center text-xl lg:initial font-semibold whitespace-nowrap text-white">Odyssey</span>
                        </a>
                        ...
                        <div class="flex">
                            <form method="get" action="<?= BASE_URL ?>/car/search">
                                ...
                                <div class="relative hidden lg:block w-[30vw]">
                                    ...
                                    <input type="text" id="search-navbar" name="query-terms"
                                        class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50"
                                        placeholder="Search for your dream car..." autocomplete="off">
                        ...
                        <div class="items-center justify-between hidden w-full lg:flex md:w-auto md:order-1" id="navbar-search">
                            ...
                            <ul
                                ...
                                <li>
                                    <a href="<?= BASE_URL ?>"
                                        class="block py-2 pl-3 pr-4 <?= $current_page == '' ? 'text-white' : 'text-orange-600' ?> rounded md:bg-transparent md:p-0"
                                        aria-current="page">Home</a>
                                </li>
                                <li>
                                    <a href="<?= BASE_URL ?>/car/index"
                                        class="block py-2 pl-3 pr-4 <?= $current_page == 'car/index' ? 'text-orange-600' : 'text-white' ?> rounded md:hover:text-orange-600 md:p-0"
                                ...
                                if ($user_id != "") {
                                    ...
                                    ?>
                                    <li>
                                        <a class="login-icon" href="<?= BASE_URL ?>/user/login">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25">
                                                <path
                                                    d="M12 12c2.481 0 4.5-2.019 4.5-4.5S14.481 3 12 3 7.5 5.019 7.5 7.5 9.519 12 12 12zm0 2c-2.757 0-8 1.383-8 4v1h16v-1c0-2.617-5.243-4-8-4z" />
                                            </svg>
    ...
    public static function displayFooter()
    {
        ?>
            ...
            <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
                <div class="md:flex md:justify-between max-w-[90vw] mx-auto my-0">
                    <div class="mb-6 md:mb-0">
                        <a href="<?= BASE_URL ?>" class="flex items-center">
                            <img src="<?= BASE_URL ?>/www/img/or-logo.png" class="h-10 mr-3" alt="Rental Logo" />
                            <span
                                class="logo-text self-center text-2xl font-semibold whitespace-nowrap text-black">Odyssey</span>
                        </a>
                    </div>
