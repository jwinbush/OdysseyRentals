        ...
        <section class="text-gray-700 body-font overflow-hidden bg-white h-full">
            <div class="container px-5 py-6 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="<?=$model?>" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src="<?=$image?>">
                ...
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4" viewBox="0 0 24 24">
                  <path d="M6 9l6 6 6-6"></path>
                        ...
                        <div class="flex">
                            ...
                            <button class="flex ml-auto text-white border-0 py-2 px-6 focus:outline-none bg-gradient-to-r from-blue-500 to-cyan-400 rounded">Reserve</button>
