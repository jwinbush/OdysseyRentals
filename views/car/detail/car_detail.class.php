...
//        }
        ...
        <section>
            <nav class="flex pt-24 max-w-[92vw] mx-auto my-0" aria-label="Breadcrumb">
        ...
        <section class="text-gray-700 body-font overflow-hidden bg-white h-full">
            <div class="container px-5 py-6 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="<?= $model ?>" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200"
                        src="<?= $image ?>">

                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 class="text-sm title-font text-gray-500 tracking-widest"><?= $category ?></h2>
                        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1"><?= $year . " " . $make . " " . $model ?>
                        </h1>
                        <div class="flex mb-4">
